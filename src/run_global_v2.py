...
# Training and testing only on real data
# if __name__ == "__main__":
#     train_dataset, test_dataset, user_groups = get_dataset(args())
#     trained_model, results = train(train_dataset, test_dataset)
#     torch.save(trained_model, f"classifier_global_ONLY_REAL.pth")
#     with open(f'./results/results_ONLY_REAL', 'wb') as f:
#         pickle.dump(results, f)
