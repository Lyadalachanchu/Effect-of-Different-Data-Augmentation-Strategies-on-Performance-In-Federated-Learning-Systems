...
if __name__ == '__main__':
    ...
    args = args_parser()
    exp_details(args)
    print(f"real minority: {args.minority}")
    ...
    sys.path.append('C:/Users/LohithSai/Desktop/FederatedImputation')
    # BUILD MODEL
    if args.model == 'cnn':
        ...
        if args.pretrain:
            print("loading pretrained classifer")
            model_path = f"C:\\Users\\LohithSai\\Desktop\\FederatedImputation\\TheArchive\\global_classifier_experiments\\run_one\\classifier_global_{args.dirichlet}.pth"
    ...
    file_name = '../save/another_objects/fedimputed_cvae_{}_{}_{}_{}_{}_C[{}]_iid[{}]_E[{}]_B[{}]_minority_{}.pkl'.\
        format(args.num_generate, args.dirichlet, args.dataset, args.model, args.epochs, args.frac, args.iid,
               args.local_ep, args.local_bs, args.minority)
    ...
    torch.save(global_model.state_dict(), f"C:\\Users\\LohithSai\\Desktop\\FederatedImputation\\vae_data\models\\{args.num_generate}_{args.model}_{args.dirichlet}_{args.minority}_cvae.pth")
